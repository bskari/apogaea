...
void displaySpectrumAnalyzer(uint8_t brightness_p, bool rainbow, bool normalizeBands, uint8_t sensitivity_p, uint8_t speed_p, int patternLength, int tileOffset, uint16_t rgb, bool showConverterLeds);
